...
import 'package:ahes_maps/screens/new_home_screen/jadwal_sholat_screen.dart';
import 'package:ahes_maps/screens/panduan_haji.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class HomeJemaahScreen extends StatelessWidget {
  HomeJemaahScreen({super.key});

  final HomeJemaahController controller = Get.put(HomeJemaahController());
  final MainJemaahController mainController = Get.find<MainJemaahController>();
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          ...
          if (label.contains('Lokasi\nFasilitas')) {
            mainController.changePage(2);
          }
          if (label.contains('Panduan\nHaji')) {
            Get.to(
              () => const PanduanHajiPage(),
            );
          }
          if (label.contains('Jadwal\nIbadah')) {
            // Get.to(
